...
The execution direction of Drayker without dates: the same phases as the global roadmap, each with the condition that must be true before the next begins, and what runs today marked.
